...
В рамках данного проекта была разработана библиотека "s21_decimal.h" на языке программирования C. Эта библиотека добавила функциональность для работы с типом данных "decimal", который отсутствует в стандартном языке C. Тип "decimal" имеет особое значение в финансовых вычислениях, где высокая точность является критически важной, и не допускается погрешности, характерные для типов данных с плавающей точкой. В ходе выполнения проекта, были рассмотрены задачи обработки финансовой информации, изучено внутреннее представление различных типов данных, и применен структурный подход для решения данной задачи.
